            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="ml-4 space-y-6">
                  <div>
                    <h3 className="text-2xl font-bold text-accent mb-3">2.1 Personal Information</h3>
                    <p className="text-neutral-white/80 mb-3">We may collect personal information that you voluntarily provide, including:</p>
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-accent mb-3">2.2 Automatically Collected Information</h3>
                    <p className="text-neutral-white/80 mb-3">We automatically collect certain information when you visit our website:</p>
                    <ul className="list-disc list-inside space-y-2 text-neutral-white/80">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-accent mb-3">2.3 Technical Information</h3>
                    <p className="text-neutral-white/80 mb-3">In providing our AI development services, we may collect:</p>
                    <ul className="list-disc list-inside space-y-2 text-neutral-white/80">
              ...
              <div>
                ...
                <p className="text-neutral-white/80 mb-3">We use collected information for the following purposes:</p>
                <ul className="list-disc list-inside space-y-2 text-neutral-white/80">
              ...
              <div>
                ...
                <p className="text-neutral-white/80 mb-3">We may share your information in the following circumstances:</p>
                
                <div className="ml-4 space-y-6">
                  <div>
                    <h3 className="text-2xl font-bold text-accent mb-3">4.1 Service Providers</h3>
                    <p className="text-neutral-white/80 mb-3">We may share information with trusted third-party service providers who assist in:</p>
                    <ul className="list-disc list-inside space-y-2 text-neutral-white/80">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-accent mb-3">4.2 Legal Requirements</h3>
                    <p className="text-neutral-white/80 mb-3">We may disclose information when required by law or to:</p>
                    <ul className="list-disc list-inside space-y-2 text-neutral-white/80">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-accent mb-3">4.3 Business Transfers</h3>
                    <p className="text-neutral-white/80">In the event of a merger, acquisition, or sale of assets, your information may be transferred to the acquiring entity.</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-neutral-white/80 mb-3">We implement appropriate technical and organizational measures to protect your information, including:</p>
                <ul className="list-disc list-inside space-y-2 text-neutral-white/80">
              ...
              <div>
                ...
                <p className="text-neutral-white/80 mb-3">We retain your information for as long as necessary to:</p>
                ...
                <p className="text-neutral-white/80">Personal information is typically retained for the duration of our business relationship and for a reasonable period thereafter as required by law.</p>
              </div>

              {/* Section 7 */}
              <div>
                <h2 className="text-3xl font-bold text-white mb-4">7. Your Privacy Rights</h2>
                <p className="text-neutral-white/80 mb-3">Depending on your location, you may have the following rights:</p>
                <ul className="list-disc list-inside space-y-2 text-neutral-white/80 mb-3">
                ...
                <p className="text-neutral-white/80">To exercise these rights, please contact us using the information provided in Section 10.</p>
              </div>

              {/* Section 8 */}
              <div>
                <h2 className="text-3xl font-bold text-white mb-4">8. Cookies and Tracking Technologies</h2>
                <p className="text-neutral-white/80 mb-3">We use cookies and similar technologies to:</p>
                <ul className="list-disc list-inside space-y-2 text-neutral-white/80 mb-3">
                ...
                <p className="text-neutral-white/80">You can manage cookie preferences through your browser settings. However, disabling certain cookies may affect website functionality.</p>
              </div>

              {/* Section 9 */}
              <div>
                <h2 className="text-3xl font-bold text-white mb-4">9. International Data Transfers</h2>
                <p className="text-neutral-white/80 mb-3">Your information may be transferred to and processed in countries other than your country of residence. We ensure appropriate safeguards are in place to protect your information during such transfers, including:</p>
                <ul className="list-disc list-inside space-y-2 text-neutral-white/80">
              ...
              <div>
                ...
                <p className="text-neutral-white/80 mb-3">We may update this Privacy Policy periodically to reflect changes in our practices, services, or legal requirements. We will notify you of material changes by:</p>
                <ul className="list-disc list-inside space-y-2 text-neutral-white/80 mb-3">
                  <li>Posting the updated policy on our website</li>
                  <li>Updating the "Last Updated" date</li>
                  <li>Sending email notifications for significant changes (where applicable)</li>
                </ul>
                <p className="text-neutral-white/80">Your continued use of our services after such modifications constitutes acceptance of the updated Privacy Policy.</p>
              </div>

              {/* Section 12 */}
              <div>
                <h2 className="text-3xl font-bold text-white mb-4">12. Third-Party Links</h2>
                <p className="text-neutral-white/80">Our website may contain links to third-party websites or services. This Privacy Policy does not apply to such third-party sites. We encourage you to review the privacy policies of any third-party sites you visit.</p>
              </div>
